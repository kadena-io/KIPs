...
QuickSign is part of the [Kadena Signing API](https://github.com/kadena-io/signing-api). This method allows the wallet to show the user multiple transactions that need signature approval.
...
1. `params`: `Object`\
    1.1. `commandSigDatas`: `Array<Object>` - A list of `CommandSigData` to sign. The properties of this type are defined in
...
1. `result`: `Object`\
    1.1. `responses`: `Array<Object>` - A list of `Response` contained signed . The properties of this type are defined in
[kip-0015 QuickSign Signing API v1](https://github.com/kadena-io/KIPs/blob/master/kip-0015.md#response-1).

If signing was NOT successful, then the `result` object contains the following properties:
1. `result`: `Object`\
    1.1. `error`: `Object` - A list of `QuicksignError`. The properties of this type are defined in
[kip-0015 QuickSign Signing API v1](https://github.com/kadena-io/KIPs/blob/master/kip-0015.md#quicksignerror).
...
1. `params`: `Object` - A `signingCmd` object whose properties are defined in the
...
1. `result`: `Object`\
    1.1. `signedCmd`: `Object` - The signed command ready to be submitted to the blockchain. Its properties are defined in the [Pact Command](https://kadena-io.github.io/signing-api/#/definitions/Command) type.
